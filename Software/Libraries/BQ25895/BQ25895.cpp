...
// Powerbank object
TI_bq25895::TI_bq25895() {
  
}

// Function to intialise
void TI_bq25895::init() {
  Wire.begin();
...
/*****************************************************************/
uint16_t TI_bq25895::read_Register(int regAddress) {
  byte data = 0;
...
/*****************************************************************/
void TI_bq25895::write_Register(int regAddress, byte data) {
  Wire.beginTransmission(0x6a);
  Wire.write(regAddress);
  Wire.write(data);
  Wire.endTransmission();
...
/*****************************************************************/
void TI_bq25895::disable_CHG_WDT() {
...
/*****************************************************************/
void TI_bq25895::set_IINDPM(float IINDPM_setting){
...
/*****************************************************************/
void TI_bq25895::set_ICHG(float ICHG_setting){
...
/*****************************************************************/
void TI_bq25895::set_HIZ(_Bool setting){
...
/*****************************************************************/
unsigned char TI_bq25895::get_VBUS(){
    int i;
    unsigned char reg;
    for (i=0; i<3; i++){
        startADC();
...
/*****************************************************************/
void TI_bq25895::set_VINDPM(char VINDPM_setting){
...
/*****************************************************************/
unsigned char TI_bq25895::get_ICHGR(){
    int i;
    unsigned char reg;
    for (i=0; i<3; i++){
        startADC();
